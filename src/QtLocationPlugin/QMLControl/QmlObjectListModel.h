...
/**
 * @brief The QmlObjectListModel class
 *
 * QAbstractListModel provides a standard interface for models that represent their
 * data as a simple non-hierarchical sequence of items. It is not used directly,
